...
# micro, cloud 만 제거
`
find ./ -name "micro-*-0.0.3-20220819*"  -type f -ls -exec rm {} +
find ./ -name "micro-*-0.0.3-20220822.03*"  -type f -ls -exec rm {} +
find ./ -name "micro-*-0.0.3-20220822.04*"  -type f -ls -exec rm {} +
